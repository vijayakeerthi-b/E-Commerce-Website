  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Register</span> AT KEERTHI FASHIONS
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<input type="tel" pattern="[0-9-{3}-[0-9]{3}-[0-9]{4}" class="form-control" name="c_contact" required>
...
<a href='localhost/ecommm/customer/my_account.php?$customer_confirm_code'>
