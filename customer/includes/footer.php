<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--whybuy">
				<div class="footer-nav__heading">Why buy from KEERTHI FASHIONS</div>
				<ul class="footer-nav__list">
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--account">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Order Tracking</a>
					</li>
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: KEERTHI Fashion.<br>
				Ullalu, Bangalore, Karnataka - 560056
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0123456789">7760784661</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@yourwebsite.com" class="email__addr">yashwanthmp2@gmail.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="developer">
				Dev by Yashwanth M P
			</div>

			<div class="designby">
				Design by Yashwanth M P
			</div>
		</div>
	</div>
</footer>
